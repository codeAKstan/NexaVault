      ...
      <div className="bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-gray-800 pt-8 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            ...
            <Link href="/signup" className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 hover:border-primary text-secondary dark:text-white px-6 py-2.5 rounded-full font-bold text-sm flex items-center gap-2 transition-all shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {[
              ...
              <div key={i} className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-100 dark:border-gray-700">
                  ...
                  <Link href="/signup" className="bg-secondary text-white dark:bg-white dark:text-secondary px-6 py-2 rounded-lg font-bold text-sm hover:opacity-90 transition-opacity">
                    Vote Now
                  </Link>
                </div>
              </div>
            ...
            <Link href="/signup" className="block w-full py-4 border border-dashed border-gray-300 dark:border-gray-600 rounded-2xl text-gray-500 font-medium hover:border-primary hover:text-primary transition-colors text-center">
              Load More Proposals
            </Link>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <Link href="/signup" className="block w-full mt-6 text-sm text-emerald-500 font-bold hover:text-emerald-600 text-center">
                View all history
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-primary to-emerald-600 rounded-3xl p-6 text-white shadow-lg shadow-emerald-500/20">
              ...
              <Link href="/signup" className="block w-full bg-white text-primary font-bold py-3 rounded-xl hover:bg-emerald-50 transition-colors shadow-sm text-center">
                Choose a Delegate
              </Link>
            </div>
          </div>
