          ...
          <div className="bg-secondary dark:bg-slate-800 rounded-[2.5rem] p-12 text-center relative overflow-hidden">
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/signup" className="bg-primary text-white px-8 py-3 rounded-full font-bold hover:bg-emerald-600 transition-colors">
                  Open App
                </Link>
                <Link href="#" className="bg-transparent border border-white/30 text-white px-8 py-3 rounded-full font-bold hover:bg-white/10 transition-colors">
                  View Documentation
                </Link>
              </div>
            </div>
