      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-slate-950">
        <div className="max-w-md w-full">
          ...
          <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); handleNext(); }}>
            ...
            {step === 4 && (
              <>
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2" htmlFor="confirmPassword">Confirm Password</label>
                  <div className="relative">
                    <input
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 dark:bg-slate-900 focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none"
                      id="confirmPassword"
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link className="font-bold text-primary hover:text-emerald-600 transition-colors" href="/login">Log in</Link>
          </p>
